...
public class MemberControllerHomeworkTest_V1 {
    ...
    private MemberDto.Post post1;
    private String content1;

    private ResultActions actions1;
    ...
    public void init() throws Exception {
        post = new MemberDto.Post("dlglwo123@naver.com","이희재","010-2312-5434");
        content = gson.toJson(post);

        post1 = new MemberDto.Post("dlglwo@gamil.com","이철광","010-2364-5676");
        content1 = gson.toJson(post1);
    ...
    void patchMemberTest() throws Exception {
        ...
        // 목적 : 전화번호 수정
        //given
        MemberDto.Patch patch = new MemberDto.Patch(memberId,null,"010-6554-2342",null);
        String PatchContent = gson.toJson(patch);

        //when : MockMvc 로 테스트 대상 controller 핸들러 메서드 요청을 하기 위해서는 Perform 메서드 호출
        ...
        // then : ResultActions 객체를 이용해 request 대한 검증
        patchActions.
